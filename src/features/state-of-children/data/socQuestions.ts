...
const illnessCourseQuestions: SOCQuestion[] = [
    createQuestion({
        ...
        options: [
            ...
            { id: 'each_fever', label: 'החמרה עם כל מחלה', value: 'each_fever' },
            { id: 'other', label: 'אחר', value: 'other' },
        ],
        ppnEquivalent: 'Q11',
    }),
    createQuestion({
        ...
        category: 'illness_course',
        type: 'yes_no',
        questionText: 'האם הילד/ה לא יכל/ה להגיע לגן/בית הספר בשלב כלשהו?',
        required: true,
        ppnEquivalent: 'Q12',
    }),
    createQuestion({
        ...
        options: [
            ...
            { id: 'toddler', label: 'צעיר מגילאי גן/בית ספר', value: 'toddler' },
            { id: 'other', label: 'אחר', value: 'other' },
        ],
        dependsOn: {
...
const diagnosisQuestions: SOCQuestion[] = [
    ...
    createQuestion({
        ...
        options: [
            ...
            { id: '2_years_plus', label: 'יותר משנתיים', value: '2_years_plus' },
            { id: '3_years_plus', label: 'יותר משלוש שנים', value: '3_years_plus' },
            { id: '5_years_plus', label: '5-8 שנים', value: '5_years_plus' },
            { id: '8_years_plus', label: '8-10 שנים', value: '8_years_plus' },
            { id: '10_years_plus', label: 'יותר מ 10 שנים', value: '10_years_plus' },
        ],
        ppnEquivalent: 'Q18',
    }),
    createQuestion({
...
const currentStatusQuestions: SOCQuestion[] = [
    ...
    createQuestion({
        ...
        options: [
            ...
            { id: 'preschool', label: 'גן - טרום חובה/חובה', value: 'preschool' },
            { id: 'toddler', label: 'צעיר.ה משלוש שנים', value: 'toddler' },
            { id: 'university', label: 'לימודים על-תיכוניים', value: 'university' },
