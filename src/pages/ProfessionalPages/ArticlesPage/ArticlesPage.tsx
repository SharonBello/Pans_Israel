...
const ARTICLES: Article[] = [
    {
        title: 'Clinical Presentation of Pediatric Autoimmune Neuropsychiatric Disorders Associated with Streptococcal Infections in Research and Community Settings',
        authors: 'Swedo SE, Seidlitz J, Kovacevic M, Latimer ME, Hommer R, Lougee L, Grant P',
        journal: 'Journal of Child and Adolescent Psychopharmacology',
        year: 2015,
        url: 'https://doi.org/10.1089/cap.2014.0073',
        tag: 'PANS',
        abstract: 'קריטריוני האבחון הרשמיים ל-PANDAS — מאמר הייחוס המרכזי. מגדיר תחילה פתאומית, OCD/הגבלות מזון ו-2+ תסמינים נוספים.',
    },
    {
        ...
        authors: 'Swedo SE, Leonard HL, Garvey M, Mittleman B, Allen AJ, Perlmutter S, Dow S, Zamkoff J, Dubbert BK, Lougee L',
    ...
    {
        title: 'Therapeutic Plasma Exchange and Intravenous Immunoglobulin for Obsessive-Compulsive Disorder and Tic Disorders in Childhood',
        authors: 'Perlmutter SJ, Leitman SF, Garvey MA, Hamburger S, Feldman E, Leonard HL, Swedo SE',
        journal: 'Lancet',
        year: 1999,
        url: 'https://doi.org/10.1016/S0140-6736(98)12297-3',
        tag: 'טיפול',
        tagColor: '#1565c0',
    ...
    {
        title: 'Multidisciplinary Clinic Dedicated to Treating Youth with Pediatric Acute-Onset Neuropsychiatric Syndrome: Presenting Characteristics of the First 47 Consecutive Patients',
        authors: 'Frankovich J, Thienemann M, Pearlstein J, Crable A, Brown K, Chang K',
        journal: 'Journal of Child and Adolescent Psychopharmacology',
        year: 2015,
        url: 'https://doi.org/10.1089/cap.2014.0081',
        tag: 'PANDAS',
        abstract: 'סדרת מקרים מ-Stanford PANS Program — מאפייני מחלה, טיפולים ותוצאות ב-47 ילדים.',
    },
    {
        title: 'Antineuronal Antibodies in Movement Disorders',
        authors: 'Kiessling LS, Marcotte AC, Culpepper L',
        journal: 'Pediatrics',
        year: 1993,
        url: 'https://pubmed.ncbi.nlm.nih.gov/8516083/',
        tag: 'מחקר בסיסי',
        tagColor: '#6a1b9a',
        abstract: 'אחד המאמרים הראשונים לתאר נוגדנים נגד נוירונים בהפרעות תנועה — בסיס למנגנון האוטואימוני.',
    },
    {
        title: 'Antibiotic Prophylaxis with Azithromycin or Penicillin for Childhood-Onset Neuropsychiatric Disorders',
        authors: 'Snider LA, Lougee L, Slattery M, Grant P, Swedo SE',
        journal: 'Biological Psychiatry',
        year: 2005,
        url: 'https://doi.org/10.1016/j.biopsych.2004.12.035',
        tag: 'טיפול',
        tagColor: '#1565c0',
        abstract: 'פרופילקסיס ארוך טווח עם Azithromycin ו-Penicillin הפחית משמעותית אפיזודות PANDAS חוזרות.',
    },
    {
        ...
        authors: 'Chang K, Frankovich J, Cooperstock M, Cunningham MW, Latimer ME, Murphy TK, Pasternack M, Thienemann M, Williams K, Walter J, Swedo SE',
        journal: 'Journal of Child and Adolescent Psychopharmacology',
        year: 2015,
        url: 'https://doi.org/10.1089/cap.2014.0084',
        tag: 'סקירה',
        tagColor: '#2e7d32',
